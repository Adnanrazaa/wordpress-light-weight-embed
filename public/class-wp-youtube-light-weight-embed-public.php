 ...
 * @subpackage Wp_Youtube_Light_Weight_Embed/public
 */
 ...
 */
class Wp_Youtube_Light_Weight_Embed_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Wp_Youtube_Light_Weight_Embed_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Wp_Youtube_Light_Weight_Embed_Loader will then create the relationship
	...
	public function wp_youtube_video_shortcode($atts)
	{
	    ...
	    $wp_guru_shortcode_render = shortcode_atts(array(
	        ...
	        'show-related' => $wordpress_youtube_light_weight_settings_options['related_videos_5'],
	        'url' => 'https://www.youtube.com/watch?v=nwgjke1ng5s',
	        'thumb-url' => '',
	    ), $atts);
	...
	public function enqueue_scripts() {
		...
		$dataToBePassed = array(
		    'width'            => $wordpress_youtube_light_weight_settings_options['width_0'],
		    'allowfullscreen' => $wordpress_youtube_light_weight_settings_options['disable_fullscreen_3'],
		    'showcontrols' => $wordpress_youtube_light_weight_settings_options['show_controls_2'],
		    'thumbnail' => $this->thumbnail,
		    'showrelated' => $wordpress_youtube_light_weight_settings_options['related_videos_5'],
		);
